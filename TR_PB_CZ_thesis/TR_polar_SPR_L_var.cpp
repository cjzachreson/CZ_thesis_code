//
//  main.cpp
//  periodic bounds fixed N model to prove that the bi-modal cluster size distributions reported by peruani et al are an artefact of their small system size, which they decrease in order to decrease density instead of increasing N. 
...
int main(int argc, const char * argv[]) {
    ...
    string state = "AR_6_kappa_0p3_2";
    
    //not adjusting this, just turning off the reversal call by making the Trev input to the twitching function equal to tf
